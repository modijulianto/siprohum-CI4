...
<div class="row">
    <div class="col-md-6">
        <div class="card text-black mt-4 mb-3" style="max-width: 100%;">
            <div class="card-header text-white" style="background: #288ACB;">
                <h6 class="m-0"><b><i class="fas fa-book"></i>&emsp; Statistik Jenis Produk Hukum</b></h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card text-black mt-4 mb-3" style="max-width: 100%;">
            <div class="card-header text-white" style="background: #288ACB;">
                <h6 class="m-0"><b><i class="fas fa-book"></i>&emsp; Statistik Kategori Produk Hukum</b></h6>
            </div>
            <div class="card-body">
                <table class="highchart" data-graph-container-before="1" data-graph-type="column" style="display:none" data-graph-datalabels-enabled="1" data-graph-datalabels-color="white">
                    <thead>
    ...
    <div class="col-md-12">
        <div class="card text-black mt-4 mb-3" style="max-width: 100%;">
            <div class="card-header text-white" style="background: #288ACB;">
                <h6 class="m-0"><b><i class="fas fa-book"></i>&emsp; Statistik Produk Hukum per Tahun </b></h6>
            </div>
            <div class="card-body">
                <table class="highchart" data-graph-container-before="1" data-graph-type="column" style="display:none" data-graph-datalabels-enabled="1" data-graph-datalabels-color="white">
                    <thead>
