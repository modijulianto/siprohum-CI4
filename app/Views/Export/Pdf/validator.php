...
<body>
    ...
    <hr height="2px">
    <h3 align="center" class="font-trn"><b>DATA VALIDATOR</b></h3>
    <br><br>
    ...
    <table border="1" cellpadding="2">
        <thead>
            <tr>
                ...
                <th align="center" style="background-color:#44749D;"><b>Nama Validator</b></th>
    ...
    <table>
        <tr>
            <td width="100px">Jumlah validator</td>
            <td>: <?= $tot_opr ?> </td>
        </tr>
        </tbody>
    </table>
